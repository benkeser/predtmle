...
#' "adult" data from UCI Machine Learning Repository
#' 
...
#' "bank" data from UCI Machine Learning Repository
#' 
#' Description (copied from UCI):
...
#' @name bank
#' @docType data
#' @references \url{https://archive.ics.uci.edu/ml/datasets/Bank+Marketing}
...
#' "Cardiotocography" data from UCI Machine Learning Repository
...
#' @references \url{https://archive.ics.uci.edu/ml/datasets/Cardiotocography}
NULL

#' "default of credit card clients" data from UCI Machine Learning Repository 
#' Data Set Information:
...
#' @docType data
#' @keywords data
#' @references \url{https://archive.ics.uci.edu/ml/datasets/default+of+credit+card+clients}
...
#' @docType data
#' @keywords data
#' @references \url{https://archive.ics.uci.edu/ml/datasets/Drug+consumption+\%28quantified\%29}
#' @references \url{https://arxiv.org/abs/1506.06297}
NULL


#' "MAGIC Gamma Telescope Data Set" from UCI Machine Learning Repository 
#' 
...
#' @references \url{https://archive.ics.uci.edu/ml/datasets/MAGIC+Gamma+Telescope}
...
#' The red and white wine data sets have been combined with an added attribute for red vs. white. 
#' Data Set Information (copied from UCI):
